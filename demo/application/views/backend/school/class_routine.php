        ...
        <br>
                                                ...
                                                <tr class="gradeA">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="btn-group">
                                                         ...
                                                         <li>
                                                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?school/class_routine/delete/<?php echo $row2['class_routine_id'];?>');">
            ...
            <br><br>
                <div class="box-content">
                    <?php echo form_open(base_url() . 'index.php?school/class_routine/create' , array('class' => 'form-horizontal form-groups validate','target'=>'_top'));?>
...
<script type="text/javascript">
    function get_class_section_subject(class_id) {
        $.ajax({
            url: '<?php echo base_url();?>index.php?school/get_class_section_subject/' + class_id ,
