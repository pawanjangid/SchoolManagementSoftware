<?php 
$edit_data		=	$this->db->get_where('grade' , array('grade_id' => $param2,'school_id' => $this->session->userdata('school_id')) )->result_array();
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                <?php echo form_open(base_url() . 'index.php?school/grade/do_update/'.$row['grade_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
            <div class="padded">
