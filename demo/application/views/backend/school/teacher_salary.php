...
?>
<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_teacher_salary');" 
...
<script type="text/javascript">
    ...
    $.ajax({
            url: '<?php echo base_url();?>index.php?school/get_teacher_salary/' + teacher_id,
