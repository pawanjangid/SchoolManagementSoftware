...
<tbody>
    <?php
    $count = 1;
    $notices = $this->db->get_where('noticeboard', array('status' => 1,'school_id'=>$this->session->userdata('school_id')))->result_array();
            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo base_url() ?>index.php?school/noticeboard/mark_as_archive/<?php echo $row['notice_id'] ?>">
