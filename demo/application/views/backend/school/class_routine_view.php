<hr />
<a href="<?php echo base_url();?>index.php?school/class_routine_add"
        ...
        <div class="panel panel-default" data-collapsed="0">
            <div class="panel-heading" >
                <div class="panel-title" style="font-size: 16px; color: white; text-align: center;">
                    ...
                    <a href="<?php echo base_url();?>index.php?school/class_routine_print_view/<?php echo $class_id;?>/<?php echo $row['section_id'];?>" 
