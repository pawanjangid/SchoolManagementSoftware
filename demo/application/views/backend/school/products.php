<a href="<?php echo base_url();?>index.php?seller/product_add" class="btn btn-primary pull-right">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-success btn-sm" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_product_profile/<?php echo $row['product_id'];?>');">
                                        <i class="entypo-eye"></i>
                                    </button>
                                </div>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-info btn-sm" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_product_edit/<?php echo $row['product_id'];?>');">
