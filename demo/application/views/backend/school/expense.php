...
<table class="table table-bordered datatable" id="table_export">
    ...
    <tbody>
        <?php 
        	...
        	$expenses = $this->db->get_where('payment', array('school_id' => $this->session->userdata('school_id')))->result_array();
            ...
            <td>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <li>
                        	<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?school/expense/delete/<?php echo $row['payment_id'];?>');">
