                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li class="divider"></li>
                                        				<li>
                                        	<a href="<?php echo base_url();?>index.php?school/experience/<?php echo $row['teacher_id'];?>");">
                                            	<i class="entypo-pencil"></i>
                                        ...
                                        <li class="divider"></li>
                                                        <li>
                                            <a href="<?php echo base_url();?>index.php?school/appointment/<?php echo $row['teacher_id'];?>");">
                                                <i class="entypo-pencil"></i>
                                        ...
                                        <li>
                                        	<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?school/teacher/delete/<?php echo $row['teacher_id'];?>');">
