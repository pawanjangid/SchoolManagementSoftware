	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                <?php echo form_open(base_url() . 'index.php?school/subject/do_update/'.$row['subject_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                ...
                <div class="form-group">
                        <label for="field-2" class="col-sm-3 control-label">Subject Type</label>
                        
                        <div class="col-sm-5">
                            <select name="type" class="form-control selectboxit">
                            <?php
                                $type = $this->db->get_where('subject' , array('subject_id' => $row['subject_id'],'school_id' => $this->session->userdata('school_id')))->row()->type;
                            ?>
                              <option value=""><?php echo get_phrase('select');?></option>
                              <option value="1" <?php if($type == '1')echo 'selected';?>>Major</option>
                              <option value="0"<?php if($type == '0')echo 'selected';?>>Minor</option>
                          </select>
                        </div> 
                </div>
