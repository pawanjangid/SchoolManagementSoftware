                ...
                <div style="margin-top: -50px;">
                   ...
                   <div class="btn-group" style="float: right;">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                            <a href="<?php echo base_url();?>index.php?school/student_marksheet/<?php echo $row['student_id'];?>">
                                        ...
                                        <li>
                                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_take_payment/<?php echo $row['enroll_id'];?>');">
                                            <i class="entypo-bookmarks"></i>
                                            <?php echo get_phrase('take_payment');?>
                                        </a>
                                        </li>
                                        <li>
                                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_view_invoice/<?php echo $row['enroll_id'];?>');">
                                            <i class="entypo-credit-card"></i>
