	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?school/student/do_update/'.$row['student_id'].'/'.$row['class_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
								<input type="text" class="datepicker form-control" name="date_of_admission" value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->date_of_admission; ?>"/>
						</div>
					</div>
