...
$total_fee = $class['tution_fee']+$class['session_fee']+$class['examination_fee']+$class['computer_academics']+$class['sports']+$class['extra_co_curricular']+$class['laboratory_fee']+$class['development_fee']+$class['adminssion_fee']+$class['other_fee'];
 ...
 <center>
 	<div>
 		<a  target="_blank" href="<?php echo base_url() . 'index.php?school/print_invoice/'.$param2; ?>" class="btn btn-default"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
 	</div>
 </center>
 ...
 <div class="row">
 	<div class="col-sm-12">
 		<div class="col-sm-6">
 			<div class="col-sm-3">
 				<img style="height: 100%; width: 100%; object-fit: contain;" src="<?php echo base_url().'uploads/school_image/' . $school['image']; ?>">
 			</div>
 			<div class="col-sm-9">
