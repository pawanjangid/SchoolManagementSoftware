<?php 
	$edit_data = $this->db->get_where('section' , array('section_id' => $param2,'school_id' => $this->session->userdata('school_id')))->result_array();
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?school/sections/edit/' . $row['section_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
