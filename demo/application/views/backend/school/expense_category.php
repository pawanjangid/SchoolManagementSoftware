...
<table class="table table-bordered datatable" id="table_export">
    ...
    <tbody>
        <?php 
        	$count = 1;
        	$expenses = $this->db->get_where('expense_category', array('school_id' => $this->session->userdata('school_id')))->result_array();
            ...
            <td>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <li>
                        	<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?school/expense_category/delete/<?php echo $row['expense_category_id'];?>');">
