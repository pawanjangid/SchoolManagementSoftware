    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php
                echo form_open(base_url() . 'index.php?school/upload_academic_syllabus', array(
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="form-control selectboxit" name="class_id" id="class_id" onchange="return get_class_subject(this.value)">
                            ...
                            <?php
                            $classes = $this->db->get_where('class', array('school_id' => $data['school_id'] = $this->session->userdata('school_id')))->result_array();
...
<script type="text/javascript">
    function get_class_subject(class_id) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>index.php?school/get_subject/' + class_id,
