...
<tbody>
    <?php
    $count = 1;
    $notices = $this->db->get_where('noticeboard', array('status' => 0, 'school_id'=>$this->session->userdata('school_id')))->result_array();
            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>index.php?school/noticeboard/remove_from_archived/<?php echo $row['notice_id'] ?>" >
                        ...
                        <!-- DELETION LINK -->
                        <li>
                            <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?school/noticeboard/delete/<?php echo $row['notice_id']; ?>');">
