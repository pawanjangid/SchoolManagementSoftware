...
<div class="row">
  ...
  <div class="col-sm-4">
    <a href="<?php echo base_url();?>index.php?school/continuetocart"
	...
	<div class="col-md-10">
    	...
    	<div class="col-md-3 shadow" style="margin: 0px;" >
    			...
    			<div style="height: 300px;">
                	<div style="height: 80%;border : 2px black;" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_product_profile/<?php echo $row['product_id'];?>');">
                		<div style="height: 80%;">
...
<script type="text/javascript">
  function addtocart(product_id) {
    $.ajax({
            url: '<?php echo base_url(); ?>index.php?school/addtocart/' + product_id,
