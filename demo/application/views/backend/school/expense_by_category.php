                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select name="expense_category_id" class="form-control selectboxit" required onchange="get_by_category(this.value);">
                                ...
                                <?php 
                                    $categories = $this->db->get_where('expense_category', array('school_id' => $this->session->userdata('school_id')))->result_array();
...
<script type="text/javascript">
    ...
    $.ajax({
            url: '<?php echo base_url();?>index.php?school/get_by_category/' + cat,
