...
$enroll = $this->db->get_where('enroll', array('student_id' => $student_id,'year'=>$running_year))->row_array();
    $exams = $this->db->get_where('exam', array('class_id' =>$enroll['class_id']))->result_array();
