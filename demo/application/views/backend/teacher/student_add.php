                    ...
                    <div class="form-group" >
                        ...
                        <div class="col-sm-5">
                            <select name="dormitory_id" class="form-control select2">
                              <option value=""><?php echo get_phrase('select');?></option>
                                  <?php 
                                    $dormitories = $this->db->get_where('dormitory', array('school_id' => $school_id))->result_array();
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="transport_id" class="form-control select2">
                              <option value=""><?php echo get_phrase('select');?></option>
                                  <?php 
                                    $transports = $this->db->get_where('transport', array('school_id' => $school_id))->result_array();
