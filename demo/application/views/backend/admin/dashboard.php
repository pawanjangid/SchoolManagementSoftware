	...
	<div class="col-md-4">
		<div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="tile-stats" style="background: #008000; -moz-box-shadow: 3px 3px 5px 6px #ccc; -webkit-box-shadow: 3px 3px 5px 6px #ccc; box-shadow: 3px 3px 5px 6px #ccc;">
...
<script type="text/javascript">
    ...
    $.ajax({
            url: '<?php echo base_url();?>index.php?admin/get_by_number/' + number,
    ...
    $.ajax({
            url: '<?php echo base_url();?>index.php?admin/get_by_srno/' + srno,
            success: function(response)
            {
                jQuery('#subject_holder').html(response);
            }
