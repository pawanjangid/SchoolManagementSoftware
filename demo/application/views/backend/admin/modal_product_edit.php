<?php 
$edit_data		=	$this->db->get_where('products' , array('product_id' => $param2) )->result_array();
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                    <?php echo form_open(base_url() . 'index.php?admin/product/do_update/'.$row['product_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="seller_id" class="form-control" data-validate="required" 
                              ...
                              <option value=""><?php echo get_phrase('select');?></option>
                              <?php 
                                $sellers = $this->db->get('seller')->result_array();
                                foreach($sellers as $row3):
                                    ?>
                                    <option value="<?php echo $row3['seller_id'];?>" <?php if($row3['seller_id'] == $row['seller_id'])echo 'selected';?>>
                                            <?php echo $row3['name'];?>
                                            </option>
                                <?php
                                endforeach;
