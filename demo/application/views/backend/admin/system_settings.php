            ...
            <div class="panel panel-primary" >
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-4">
                          <input type="text" class="form-control" name="school_name_hindi" 
                              value="<?php echo $this->db->get_where('settings' , array('type' =>'school_name_hindi'))->row()->description;?>">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <label  class="col-sm-2 control-label"><?php echo get_phrase('Dice code');?></label>
                      <div class="col-sm-4">
                          <input type="text" class="form-control" name="dice_code" 
                              value="<?php echo $this->db->get_where('settings' , array('type' =>'dice_code'))->row()->description;?>">
                      </div>
                  </div>
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-sm-4">
                          <input type="text" class="form-control" name="sms_api" 
                              value="<?php echo $this->db->get_where('settings' , array('type' =>'sms_api'))->row()->description;?>">
                      </div>
                      ...
                      <div class="col-sm-4">
                          <input type="text" class="form-control" name="sms_sender_id" 
                              value="<?php echo $this->db->get_where('settings' , array('type' =>'sms_sender_id'))->row()->description;?>">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control" name="school_registeration_number" 
                              value="<?php echo $this->db->get_where('settings' , array('type' =>'school_registeration_number'))->row()->description;?>">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('Head Authority');?></label>
                      <div class="col-sm-9">
                          <input type="text" class="form-control" name="head" 
                              value="<?php echo $this->db->get_where('settings' , array('type' =>'head'))->row()->description;?>">
                      </div>
                  </div>
      ...
      array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
        <div class="col-md-2">
            ...
            <div class="panel panel-primary" >
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <?php echo get_phrase('Logo_Setting');?>
                    </div>
                </div>
                     <div class="col-sm-5">
