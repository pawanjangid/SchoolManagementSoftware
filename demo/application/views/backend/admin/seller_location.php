...
<?php $location = $this->db->get_where('seller', array('seller_id' => $seller_id ))->row()->location_data;
$cordinate=explode(',', $location);
 ?>
 <?php
$seller_info  = $this->db->get_where('seller' , array('seller_id' => $seller_id))->result_array();
