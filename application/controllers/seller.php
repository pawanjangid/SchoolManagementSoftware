...
class Seller extends CI_Controller
{
    ...
    /***default functin, redirects to login page if no seller logged in yet***/
    public function index()
    {
        if ($this->session->userdata('seller_login') != 1)
            redirect(base_url() . 'index.php?login', 'refresh');
        if ($this->session->userdata('seller_login') == 1)
            redirect(base_url() . 'index.php?seller/dashboard', 'refresh');
    }
    ...
    function dashboard()
    {
        ...
        $page_data['page_title'] = get_phrase('seller_dashboard');
...
function products($product_category_id)
    {
        ...
        $page_data['seller_id'] =  $this->session->userdata('seller_id');
    ...
    function product($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?seller/products/' . $data['product_category_id'], 'refresh');
        }
        if ($param1 == 'do_update') {           
            $data['name']           = $this->input->post('name');
            $data['product_category_id']          = $this->input->post('product_category_id');
    ...
    function student_marksheet_print_view($student_id , $exam_id) {
        ...
        $this->load->view('backend/seller/student_marksheet_print_view', $page_data);
    }
    ...
    function student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?seller/student_add/', 'refresh');
        }
        if ($param2 == 'do_update') {
            $data['name']           = $this->input->post('name');
            $data['birthday']       = $this->input->post('birthday');
            ...
            $this->crud_model->clear_cache();
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?seller/student_information/' . $param3, 'refresh');
        } 
		
        if ($param2 == 'delete') {
            $this->db->where('student_id', $param3);
            $this->db->delete('student');
            redirect(base_url() . 'index.php?seller/student_information/' . $param1, 'refresh');
        }
    }
    ...
    /****MANAGE sellerS*****/
    function seller_list($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('seller_login') != 1)
            redirect(base_url(), 'refresh');
        ...
        if ($param1 == 'personal_profile') {
            ...
            $page_data['current_seller_id'] = $param2;
        }
        $page_data['sellers']   = $this->db->get('seller')->result_array();
        $page_data['page_name']  = 'seller';
        $page_data['page_title'] = get_phrase('seller_list');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function subject($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?seller/subject/'.$data['class_id'], 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']       = $this->input->post('name');
            $data['class_id']   = $this->input->post('class_id');
        ...
        if ($param1 == 'delete') {
            ...
            redirect(base_url() . 'index.php?seller/subject/'.$param3, 'refresh');
        }
    ...
    function marks_selector()
    {
        ...
        redirect(base_url() . 'index.php?seller/marks_manage_view/' . $data['exam_id'] . '/' . $data['class_id'] . '/' . $data['section_id'] . '/' . $data['subject_id'] , 'refresh');
    ...
    function marks_update($exam_id = '' , $class_id = '' , $section_id = '' , $subject_id = '')
    {
        ...
        redirect(base_url().'index.php?seller/marks_manage_view/'.$exam_id.'/'.$class_id.'/'.$section_id.'/'.$subject_id , 'refresh');
    }

    function marks_get_subject($class_id)
    {
        $page_data['class_id'] = $class_id;
        $this->load->view('backend/seller/marks_get_subject' , $page_data);
    }
    ...
    function upload_academic_syllabus()
    {
        ...
        redirect(base_url() . 'index.php?seller/academic_syllabus/' . $data['class_id'] , 'refresh');
    ...
    function backup_restore($operation = '', $type = '')
    {
        ...
        if ($operation == 'restore') {
            ...
            redirect(base_url() . 'index.php?seller/backup_restore/', 'refresh');
        }
        if ($operation == 'delete') {
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_profile_info') {
            ...
            move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/seller_image/' . $this->session->userdata('seller_id') . '.jpg');
            $this->session->set_flashdata('flash_message', get_phrase('account_updated'));
            redirect(base_url() . 'index.php?seller/manage_profile/', 'refresh');
        }
        if ($param1 == 'change_password') {
            ...
            $current_password = $this->db->get_where('seller', array(
                'seller_id' => $this->session->userdata('seller_id')
            ))->row()->password;
            if ($current_password == $data['password'] && $data['new_password'] == $data['confirm_new_password']) {
                $this->db->where('seller_id', $this->session->userdata('seller_id'));
                $this->db->update('seller', array(
        ...
        $page_data['edit_data']  = $this->db->get_where('seller', array(
            'seller_id' => $this->session->userdata('seller_id')
        ))->result_array();
        $this->load->view('backend/index', $page_data);
    }
    ...
    function class_routine_print_view($class_id , $section_id)
    {
        ...
        $page_data['class_id']   =   $class_id;
        $page_data['section_id'] =   $section_id;
        $this->load->view('backend/seller/class_routine_print_view' , $page_data);
    }
    ...
    function attendance_selector()
    {
        ...
        redirect(base_url().'index.php?seller/manage_attendance_view/'.$data['class_id'].'/'.$data['section_id'].'/'.$data['timestamp'],'refresh');
    }
    ...
    function attendance_update($class_id = '' , $section_id = '' , $timestamp = '')
    {
        ...
        redirect(base_url().'index.php?seller/manage_attendance_view/'.$class_id.'/'.$section_id.'/'.$timestamp , 'refresh');
    }
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?seller/noticeboard/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['notice_title']     = $this->input->post('notice_title');
            $data['notice']           = $this->input->post('notice');
    ...
    function document($do = '', $document_id = '')
    {
        ...
        if ($do == 'upload') {
            ...
            redirect(base_url() . 'seller/manage_document', 'refresh');
        }
        if ($do == 'delete') {
    ...
    function study_material($task = "", $document_id = "")
    {
        ...
        if ($task == "create")
        {
            ...
            redirect(base_url() . 'index.php?seller/study_material' , 'refresh');
        }
        ...
        if ($task == "delete")
        {
            ...
            redirect(base_url() . 'index.php?seller/study_material');
        }
    ...
    function message($param1 = 'message_home', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'send_new') {
            ...
            redirect(base_url() . 'index.php?seller/message/message_read/' . $message_thread_code, 'refresh');
        }

        if ($param1 == 'send_reply') {
            $this->crud_model->send_reply_message($param2);  //$param2 = message_thread_code
            $this->session->set_flashdata('flash_message', get_phrase('message_sent!'));
            redirect(base_url() . 'index.php?seller/message/message_read/' . $param2, 'refresh');
        }
    ...
    function question_paper($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "create")
        {
            ...
            redirect(base_url() . 'index.php?seller/question_paper', 'refresh');
        }
