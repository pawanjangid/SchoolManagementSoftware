			...
			<div class="">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><div>
              	<a href="<?php echo base_url();?>index.php?admin/student_marksheet_print_view/<?php echo $row['student_id'];?>" target="_blank" class="btn btn-info" >Print Marksheet</a>
              </div></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a target="_blank" href="<?php echo base_url();?>index.php?admin/charactor/<?php echo $row['student_id'];?>">
