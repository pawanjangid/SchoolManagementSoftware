...
<head>
  ...
  <title>
    ANOM | Best APP and Web development Company
  </title>
  <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0, shrink-to-fit=no' name='viewport' />
  <meta name="description" content="This is an integrated and comprehensive platform for educational institutions to manage their complete task and communication between there peoples. It is a software designed especially for institutions, schools and student and parents.
The user-friendly ERP comes with login access for teachers, administrators, students, parents and management of the institute and shopkeepers and manufacturer. This paperless automation solution eliminates repeated data entry and helps them to work smart and focus on what they do best ! ">
  <!--     Fonts and icons     -->
...
})(window,document,'script','dataLayer','GTM-W4BH89F');</script>
...
gtag('config', '', { 'optimize_id': 'GTM-T9P47BS'});
</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W4BH89F"
