<?php
$product_info	=	$this->db->get_where('products' , array('product_id' => $param2,'seller_id' => $this->session->userdata('seller_id')))->result_array();
	...
	<header class="row">
		...
		<div class="col-sm-3">
			...
			<a href="#" class="profile-picture">
				<img src="<?php echo $this->crud_model->get_image_url('product' , $row['product_id']);?>" 
		...
		<div class="row">
			...
			<div class="">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><?php echo get_phrase('Product_category');?></td>
