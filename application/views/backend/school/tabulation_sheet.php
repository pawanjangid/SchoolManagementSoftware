...
<div class="row">
	<div class="col-md-12">
		<?php echo form_open(base_url() . 'school/tabulation_sheet');?>
			<div class="col-md-4">
...
<div class="row">
	<div class="col-md-12">
		...
		<center>
			<a href="<?php echo base_url();?>school/tabulation_sheet_print_view/<?php echo $class_id;?>/<?php echo $section_id;?>/<?php echo $exam_id;?>" 
...
<script type="text/javascript">
	function get_class_section(class_id) {
		...
		$.ajax({
            url: '<?php echo base_url();?>school/marks_get_section/' + class_id ,
	...
	function get_class_exam(class_id) {
		...
		$.ajax({
            url: '<?php echo base_url();?>school/marks_get_exam/' + class_id ,
            success: function(response)
            {
