...
<div class="tab-content">
  ...
  <div class="tab-pane active" id="unpaid">
    ...
    <?php echo form_open(base_url() . 'school/invoice/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
    <div class="row">
     <div class="col-md-6">
            ...
            <select name="student_id" class="form-control" style="width:100%;" id="student_selection_holder">
              <option value=""><?php echo get_phrase('select_class_first');?></option>
                      ...
                      <div class="tab-pane" id="paid">
                        ...
                        <?php echo form_open(base_url() . 'school/invoice/create_mass_invoice' , array('class' => 'form-horizontal form-groups-bordered validate', 'id'=> 'mass' ,'target'=>'_top'));?>
                        <br>
                        <div class="row">
...
<script type="text/javascript">
  ...
  function get_class_students(class_id) {
    $.ajax({
      url: '<?php echo base_url();?>school/get_class_students/' + class_id ,
...
<script type="text/javascript">
  function get_class_students_mass(class_id) {
    ...
    $.ajax({
      url: '<?php echo base_url();?>school/get_class_students_mass/' + class_id ,
      success: function(response)
      {
