...
<?php echo form_open(base_url() . 'school/student_promotion/promote');?>
<div class="row">
<?php 
...
<script type="text/javascript">
    ...
    function get_students_to_promote(running_year)
    {
        ...
        $.ajax({
            url: '<?php echo base_url();?>school/get_students_to_promote/' + from_class_id + '/' + to_class_id + '/' + running_year + '/' + promotion_year,
