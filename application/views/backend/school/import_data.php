	...
	<div class="col-md-8">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'school/import_student/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
<script type="text/javascript">
	...
	function get_class_sections(class_id) {
    	$.ajax({
            url: '<?php echo base_url();?>school/get_class_section/' + class_id ,
