...
<?php echo form_open(base_url() . 'school/attendance_report_selector/'); ?>
<div class="row">
...
<?php if ($class_id != '' && $section_id != '' && $month != ''): ?>
    ...
    <b style="float: left;"><?php echo get_phrase('students'); ?><i class="entypo-down"></i></b> | <b style="float: right;"><?php echo get_phrase('date'); ?> <i class="entypo-right-thin"></i></b>
    ...
    for ($i = 1; $i <= $days; $i++) {
        ?>
                ...
                <tbody>
                            ...
                            $students = $this->db->get_where('enroll', array('class_id' => $class_id, 'year' => $running_year, 'section_id' => $section_id,'school_id'=>$this->session->userdata('school_id')))->result_array();
                        ...
                        <tr>
                            ...
                            $status = 0;
                            for ($i = 1; $i <= $days; $i++) {
                                $timestamp = strtotime($i . '-' . $month . '-' . $selectyear);
    ...
    <?php ?>
            ...
            <center>
                <a href="<?php echo base_url(); ?>school/attendance_report_print_view/<?php echo $class_id; ?>/<?php echo $section_id; ?>/<?php echo $month; ?>/<?php echo $selectyear; ?>" 
...
<script type="text/javascript">
    ...
    function select_section(class_id) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>school/get_section/' + class_id,
