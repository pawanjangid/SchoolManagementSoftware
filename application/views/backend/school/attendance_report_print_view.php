...
<div id="print">
    ...
    <b style="float: left;"><?php echo get_phrase('students'); ?><i class="entypo-down"></i></b>  | <?php echo get_phrase('date'); ?> <i class="entypo-right-thin"></i>
                        </td>
    <?php
    $year = $selectyear;
    $days = cal_days_in_month(CAL_GREGORIAN, $month, $selectyear);
    for ($i = 1; $i <= $days; $i++) {
        ?>
