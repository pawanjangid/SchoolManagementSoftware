				...
				<div class="tab-pane active" id="unpaid">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td>
                            <div class="btn-group">
                                <button type="button" class="btn btn-default btn-sm" data-toggle="dropdown" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_view_tc/<?php echo $row['tc_id'];?>');">
