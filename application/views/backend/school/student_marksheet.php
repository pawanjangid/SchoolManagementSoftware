...
<?php
    ...
    $exams         = $this->db->get_where('exam', array('school_id' => $this->session->userdata('school_id'),'class_id'=>$class_id))->result_array();
    ...
    <div class="col-md-12">
        <div class="panel panel-primary panel-shadow" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title">Marksheet for <?php echo $row2['name']; ?><a href="<?php echo base_url();?>school/student_marksheet_print_view/<?php echo $student_id;?>" 
                        class="btn btn-primary" style="background-color: #000;margin-left: 100px;" target="_blank">
                                    ...
                                    <?php
                                        if($obtained_mark_query->num_rows() > 0) {
                                            if ($row4['mark_obtained'] >= 0 || $row4['mark_obtained'] != '') {
                                                $percentage = $row4['mark_obtained']*100/$row2['maxmarks'];
                                                $grade = $this->crud_model->get_grade($percentage);
                                                echo $grade['name'];
