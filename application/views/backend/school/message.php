    ...
    <div class="col-md-12">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="unpaid">
                ...
                <?php echo form_open(base_url() . 'school/message/single' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                <div class="row">
                    <div class="col-md-6">
        ...
        <div class="tab-pane" id="paid">
            ...
            <?php echo form_open(base_url() . 'school/message/bulk_sms' , array('class' => 'form-horizontal form-groups-bordered validate', 'id'=> 'mass' ,'target'=>'_top'));?>
            <br>
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" class="form-control" name="class_message"
