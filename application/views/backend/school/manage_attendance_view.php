...
<?php echo form_open(base_url() . 'school/attendance_selector/'); ?>
<div class="row">
...
<div class="row" style="text-align: center;">
    ...
    <div class="col-sm-4">
        <div class="tile-stats tile-gray">
            ...
            <h3 style="color: #696969;"><?php echo get_phrase('attendance_for_class'); ?> <?php echo $this->db->get_where('class', array('class_id' => $class_id,'school_id' =>$this->session->userdata('school_id')))->row()->name; ?></h3>
...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <?php echo form_open(base_url() . 'school/attendance_update/' . $class_id . '/' . $section_id . '/' . $timestamp); ?>
