		...
		<table class="table table-bordered">
			<thead align="center">
				<tr>
					...
					<td align="center"><?php echo get_phrase('Old SR No.');?></td >
					<td align="center"><?php echo get_phrase('New SR No.');?></td >
			...
			?>
				<tr>
					...
					<input type="text" class="form-control" name="srno" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="<?php echo $row['srno'];?>">
					</td>
					<td>
